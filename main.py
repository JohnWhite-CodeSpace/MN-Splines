...
class main_frame(QMainWindow):
    ...
    def scatter_plot2D(self):
        ...
        self.plot_frame_1.scatterplot2D(self.x_array, self.y_array, 'x', 'y', 'blue', False)
        self.plot_frame_2.scatterplot2D(self.x_array, self.y_array, 'x', 'y', 'red', False)
        self.plot_frame_3.scatterplot2D(self.x_array, self.y_array, 'x', 'y', 'green', False)
    ...
    def scatter_plot3D(self):
        ...
        self.plot_frame_2.clear()
        self.plot_frame_3.clear()
        self.plot_frame_1.scatterplot3D(self.x_array, self.y_array, self.z_array, 'x', 'y', 'z', 'blue', False)
        self.plot_frame_2.scatterplot3D(self.x_array, self.y_array, self.z_array, 'x', 'y', 'z', 'red', False)
        self.plot_frame_3.scatterplot3D(self.x_array, self.y_array, self.z_array, 'x', 'y', 'z', 'green', False)
        self.append_all("Displayed data: ")
        self.append_all("X: ")
        for i in self.x_array:
            self.append_all(str(i))
